...
package org.TheGame.events.actionProcessing;
...
/**
 * Holds the Actions of Elements of the game as they enqueue them, and executes
 * them all sequentially when asked to process the queue
 * 
...
public class ActionPipeline {
	...
	public void executeAction(Action action) throws InvalidPositionException, OccupiedPositionException {
		// this.getActions().add(action);
		action.execute();
	}

	public void processQueue() throws InvalidPositionException, OccupiedPositionException {
