...
public class DeleteAction extends Action {
	...
	public DeleteAction(Element attacker, Direction direction) {
	 ...
	 */
	@Override
	public ActionResultDelete execute() throws InvalidPositionException, OccupiedPositionException {
		return this.getAttacker().delete(this.getDirection());
	}
