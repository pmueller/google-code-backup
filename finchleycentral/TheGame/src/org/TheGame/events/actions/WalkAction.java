...
/**
 * A MoveAction represents the action of moving in a direction of a
 * MovableElement
 * 
...
public class WalkAction extends Action {
	...
	public WalkAction(MovableElement target, Direction direction) {
	...
	public ActionResult execute() {
		this.getTarget().walk(this.getDirection());
	...
	public String toString() {
		return "Walk " + this.getTarget().toString() + " to "
