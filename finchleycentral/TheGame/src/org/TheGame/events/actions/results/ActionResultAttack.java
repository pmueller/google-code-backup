...
public class ActionResultAttack extends BaseActionResult {
	...
	public static ActionResultAttack dodge = new ActionResultAttack(
			Result.Dodge);
	public static ActionResultAttack notExecuted = new ActionResultAttack(
			Result.NotExecuted);
	public static ActionResultAttack cannotBeAttacked = new ActionResultAttack(
			Result.CannotBeAttacked);
	public static ActionResultAttack invalidTarget = new ActionResultAttack(
			Result.InvalidTarget);
	public static ActionResultAttack couldNotPerform = new ActionResultAttack(
