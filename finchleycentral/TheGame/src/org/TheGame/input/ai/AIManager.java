...
public class AIManager {
	...
	public void think() throws InvalidPositionException, OccupiedPositionException {
		// update only every updateInterval ms
		time = time
				+ GameObjects.getInstance().getTimeKeeper()
	...
	public void doThink() throws InvalidPositionException, OccupiedPositionException {
