...
public class GameInput {
	...
	/**
	 * A GameInput is used to listen to a key event. The InputManager takes care
	 * of changing it's state accordingly. The isPressed() method returns true
	 * only after the key is first pressed, and not again until the key is
