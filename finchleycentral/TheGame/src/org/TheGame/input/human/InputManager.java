...
public class InputManager implements KeyListener {
	 ...
	 * GameAction gameAction; if (amount < 0) { gameAction =
	 * mouseActions[codeNeg]; } else { gameAction = mouseActions[codePos]; } if
	 * (gameAction != null) { gameAction.press(Math.abs(amount));
	 * gameAction.release(); } }
	 */
