...
/**
 * Generates an array of random numbers and returns a different one each time a
 * random number is requested The array's values can be created again with the
 * message randomize
 * 
