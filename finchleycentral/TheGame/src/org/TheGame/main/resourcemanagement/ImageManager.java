...
public class ImageManager {
	...
	public ImageManager() {
		...
		String imageDirectoryPath = configuration.getValue("applicationPath")
				+ configuration.getValue("imageDirectory");
	...
	public BufferedImage loadImage(String fileName) {
		...
		BufferedImage image2 = FullScreenManager.getInstance()
