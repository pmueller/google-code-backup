...
public class CreepDescription {
	...
	public CreepDescription(
			CreepElementTypeDescription creepElementTypeDescription,
			CreepElementGraphicDescription creepElementGraphicDescription,
			CreepAIDescription description) {
		super();
	...
	public Creep createCreep() {
		MovableElementGraphic movableElementGraphic = this.creepElementGraphicDescription
				.createMovableElementGraphic();
		CreepElementType creepElementType = this.creepElementTypeDescription
				.createCreepElementType();
		HealthState healthState = this.createHealth(creepElementType
				.getCharacteristics());
		AI ai = this.creepAIDescription.createCreepAI();
		return new Creep(creepElementType, movableElementGraphic, ai,
				healthState);
	}
	 ...
	 * @return
	 */
	protected HealthState createHealth(
			MovableElementCharacteristics characteristics) {
		Statistic maxHealthStatistic = characteristics
				.getStatisticNamed("MaxHealth");
		Statistic maxStaminaStatistic = characteristics
				.getStatisticNamed("MaxStamina");
		Statistic healthRecoveryRate = characteristics
				.getStatisticNamed("HealthRecoveryRate");
		Statistic staminaRecoveryRate = characteristics
				.getStatisticNamed("StaminaRecoveryRate");
		AttributeState health = new AttributeState("health",
				(int) maxHealthStatistic.getValue(), maxHealthStatistic,
				healthRecoveryRate);
		AttributeState stamina = new AttributeState("stamina",
				(int) maxStaminaStatistic.getValue(), maxStaminaStatistic,
				staminaRecoveryRate);
	...
	protected void setCreepElementTypeDescription(
			CreepElementTypeDescription creepElementTypeDescription) {
		this.creepElementTypeDescription = creepElementTypeDescription;
	}
	...
	protected void setCreepElementGraphicDescription(
			CreepElementGraphicDescription creepElementGraphicDescription) {
		this.creepElementGraphicDescription = creepElementGraphicDescription;
	}
	...
	public String toString() {
		return "CreepDescription for "
				+ this.getCreepElementTypeDescription().getName();
	}
}
