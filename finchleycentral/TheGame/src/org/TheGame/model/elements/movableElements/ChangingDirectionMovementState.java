...
public class ChangingDirectionMovementState extends MovementState {
	...
	public ChangingDirectionMovementState(MovableElement movableElement,
			int changingDirectionBlockedTime) {
	...
	public void update(long timeElapsed) {
		 ...
		 */
		long newBlockedTime = this.getChangingDirectionBlockedTime()
				- timeElapsed;
	...
	public void setChangingDirectionBlockedTime(
			long changingDirectionBlockedTime) {
