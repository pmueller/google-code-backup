...
import org.TheGame.model.elements.BaseElementType;
...
public class MovableElementType extends BaseElementType {
	...
	public MovableElementType(String name, String team,
	...
	protected int getCurrentLevelOfAttribute(String attribute) {
		return this.getCharacteristics().getAttributeNamed(attribute)
				.getCurrentLevel();
	}
