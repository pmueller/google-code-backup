...
public abstract class Characteristics {
	...
	public void usedAttributeWithIntensityAndProbability(String name,
			int intensity, int probability) {
	...
	public void usedSkillWithIntensityAndProbability(String name,
			int intensity, int probability) {
		if (DiceRoller.rollDiceWithProbability(probability)) {
