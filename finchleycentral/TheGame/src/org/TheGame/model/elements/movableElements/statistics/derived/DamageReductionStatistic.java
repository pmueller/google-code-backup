 ...
 */
public class DamageReductionStatistic extends DerivedStatistic {

	public static DamageReductionStatistic newDamageReduction(float baseValue,
			Attribute constitution) {
		ArrayList<Statistic> statistics = new ArrayList<Statistic>();
		;
		statistics.add(constitution);
		return new DamageReductionStatistic("DamageReduction", baseValue,
				statistics);
	}

	public DamageReductionStatistic(String name, float baseValue,
	...
	public float calculate() {
		float value = this.getBaseValue()
				+ this.getValueOfDependingStatistic("Constitution");
