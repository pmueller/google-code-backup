...
public class DamageStatistic extends DerivedStatistic {
	...
	public static DamageStatistic newDamage(float baseValue,
			Attribute strength, Skill weapons) {
	...
	public DamageStatistic(String name, float baseValue,
	...
	public float calculate() {
		float damage = this.getBaseValue()
				+ this.getValueOfDependingStatistic("Strength") / 2
				+ this.getValueOfDependingStatistic("Weapons") / 2;
