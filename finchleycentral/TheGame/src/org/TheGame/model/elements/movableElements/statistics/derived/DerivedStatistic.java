 ...
 */
public abstract class DerivedStatistic extends Statistic implements
		StatisticObserver {
	 ...
	 * @param name
	 */
	public DerivedStatistic(String name, float baseValue,
			ArrayList<Statistic> dependingStatistics) {
		super(name);
		this.setDependingStatistics(new ArrayList<Statistic>(
				dependingStatistics));
	...
	protected void setDependingStatistics(
			ArrayList<Statistic> dependingStatistics) {
