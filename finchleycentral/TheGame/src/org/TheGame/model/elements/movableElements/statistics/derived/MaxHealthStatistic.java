...
public class MaxHealthStatistic extends DerivedStatistic {
	...
	public float calculate() {
		return this.getBaseValue()
				+ this.getValueOfDependingStatistic("Constitution") * 3
				+ this.getValueOfDependingStatistic("Strength") * 1.5f;
	}

	public static MaxHealthStatistic newMaxHealth(float baseValue,
			Attribute constitution, Attribute strength) {
	...
	public MaxHealthStatistic(String name, float baseValue,
