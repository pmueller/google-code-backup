...
public class MaxStaminaStatistic extends DerivedStatistic {
	...
	public float calculate() {
		return this.getBaseValue()
				+ this.getValueOfDependingStatistic("Endurance") * 4
				- this.getValueOfDependingStatistic("Constitution") * 0.3f;
	}

	public static MaxStaminaStatistic newMaxStamina(float baseValue,
			Attribute constitution, Attribute endurance) {
	...
	public MaxStaminaStatistic(String name, float baseValue,
