...
public class MovementSpeedStatistic extends DerivedStatistic {
	...
	public static MovementSpeedStatistic newMovementSpeed(float baseValue,
			Attribute speed) {
		ArrayList<Statistic> statistics = new ArrayList<Statistic>();
		;
		statistics.add(speed);
		return new MovementSpeedStatistic("MovementSpeed", baseValue,
				statistics);
	}

	public MovementSpeedStatistic(String name, float baseValue,
	...
	public float calculate() {
		float value = this.getBaseValue()
				- this.getValueOfDependingStatistic("Speed");
