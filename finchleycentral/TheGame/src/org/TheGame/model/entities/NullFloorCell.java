...
public class NullFloorCell extends FloorCell {
	...
	protected NullFloorCell() {
		...
		this.blankImage = new BufferedImage(Configuration.getInstance()
				.getValueAsInt("blockSize"), Configuration.getInstance()
				.getValueAsInt("blockSize"), BufferedImage.TYPE_INT_BGR);
	}
