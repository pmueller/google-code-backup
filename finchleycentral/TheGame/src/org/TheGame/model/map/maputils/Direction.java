...
public class Direction {
	...
	public static Direction newDirection(int horizontalDirection,
			int verticalDirection) {
		return DirectionCache.getInstance().getDirectionAt(horizontalDirection,
				verticalDirection);
	}
	...
	protected Direction(int horizontalDirection, int verticalDirection)
			throws InvalidDirectionValuesException {
		...
		if (horizontalDirection < -1 || horizontalDirection > 1
				|| verticalDirection < -1 || verticalDirection > 1
				|| (verticalDirection == 0 && horizontalDirection == 0)) {
			throw new InvalidDirectionValuesException(
					"Código de dirección incorrecto h: " + horizontalDirection
							+ " v: " + verticalDirection);
		}
	}
	...
	public Direction opposite() {
		return Direction.newDirection(this.getHorizontalDirection() * -1, this
				.getVerticalDirection()
				* -1);
	}

	/**
	 * @return a list of the five opposite directions in order of "farness" from
	 *         this direction
	 */
	...
	public Direction nextClockwise() {
		...
		if (direction.equals("n")) {
			...
			throw new GameError("Check if conditions, " + direction
					+ " not valid " + (nextDirection == null));
		}
