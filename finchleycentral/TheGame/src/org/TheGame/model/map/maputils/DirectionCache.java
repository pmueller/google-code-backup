...
/**
 * * A cardinal DirectionCache /////////////////////////// // -1,-1 // 0,-1 //
 * 1,-1 // /////////////////////////// /////////////////////////// // -1,0 //
 * inv // 1,0 // /////////////////////////// /////////////////////////// // -1,
 * 1 // 0,1 // 1,1 // /////////////////////////// /////////////////////////// //
 * 0,0 // 1,0 // 2,0 // /////////////////////////// ///////////////////////////
...
public class DirectionCache {
	...
	protected void setDirectionAt(int horizontalDirection,
			int verticalDirection, Direction direction) {
		this.getDirections()[horizontalDirection + 1][verticalDirection + 1] = direction;
	}

	public Direction getDirectionAt(int horizontalDirection,
	...
	public Direction getDirectionAt(String direction) {
		...
		if (direction == "n") {
			...
			throw new InvalidDirectionValuesException(
					"Nombre de dirección incorrecto " + direction);
		}
