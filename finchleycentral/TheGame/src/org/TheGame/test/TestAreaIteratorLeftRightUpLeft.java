...
public class TestAreaIteratorLeftRightUpLeft extends TestCase {
	...
	public void setUp() {
		Area area = new Area(Position.newPosition(2, 6), Position.newPosition(
				7, 11));
	...
	public void testIteration() {
		for (int j = 6; j <= 11; j++) {
			for (int i = 2; i <= 7; i++) {
				...
				Assert.assertEquals("Positions should be the same", Position
						.newPosition(i, j), position);
			}
		}
