...
import org.TheGame.visualization.graphics.element.Sprite;

/**
 * Has Animations for both the graphic of an element in it's normal state
 * (standing still) and for when it is moving. Since this can happen in 8
 * different directions, it stores 8 animations in a 3x3grid, 0,0 being -1,-1,
 * etc, with 1,1 being the center of the grid.
 * 
...
public class MovableSprite extends Sprite {
	...
	/**
	 * @param direction
	 *            : initial direction the sprite will be looking at
	 */
