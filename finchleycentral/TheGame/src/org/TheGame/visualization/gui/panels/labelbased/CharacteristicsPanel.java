...
public abstract class CharacteristicsPanel extends ObjectsListPanel {
	 ...
	 * 
	 * @see
	 * org.tiledzelda.visualization.gui.ObjectsListPanel#printObjectLabel(java
	 * .lang.Object)
	 */
	@Override
	...
	public String formatLabel(Characteristic characteristic) {
		...
		int requiredExp = characteristic
				.getExperiencePointsRequiredForCurrentLevel();
		String label = characteristic.getName() + ": " + level + " ("
