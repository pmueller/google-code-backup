...
public class StatisticsPanel extends ObjectsListPanel {
	 ...
	 * (non-Javadoc)
	 * 
	 * @seeorg.tiledzelda.visualization.gui.panels.labelbased.ObjectsListPanel#
	 * getObjects()
	 */
	@Override
	public ArrayList<Object> getObjects() {
		try {
			ArrayList<Statistic> statistics = this.getMovableElement()
					.getElementType().getCharacteristics().getStatistics();
